...
**Capítulo III** Describe el Marco Metodológico, detallando el proceso de limpieza de datos, las pruebas de hipótesis y los algoritmos utilizados para validar la calidad de la información.

**Capítulo IV** Presenta el Análisis de Resultados, donde se exhiben las tablas y gráficos generados dinámicamente.

**Capítulo V** Expone los hallazgos finales sobre qué factores determinaron la victoria en 2021. Se concluye sobre la estabilidad de los equipos y se ofrecen recomendaciones estratégicas basadas en la evidencia estadística obtenida.

# Planteamiento del Problema
 En el baloncesto de élite, ganar un partido no siempre depende de qué tan alto sea el promedio de un equipo, sino de qué tan **consistente** pueda ser ese rendimiento bajo presión. El análisis de los 1.323 registros de la NBA en 2021 revela una interrogante crítica: ¿se pierden los partidos por una falta de talento general o por una **irregularidad drástica** en momentos clave?
...
**1.** ¿Es la derrota en la NBA 2021 consecuencia de una ineficiencia constante en el tiro o se debe a una alta volatilidad e inestabilidad en el porcentaje de campo?
...
## Objetivo General
Evaluar la incidencia de la estabilidad en el tiro y la relación de variables de efectividad y posesión en el resultado final de los partidos de la NBA en el año 2021, mediante el análisis de medidas de dispersión y tablas de contingencia.
